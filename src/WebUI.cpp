...
static String htmlIndex() {
    ...
    h += F(
        ...
        "<button onclick=\"shipReadyReset()\" id='b_ship_ready'>Reset Wi-Fi</button>"
...
"</table></div>"
        ...
        "<div class='field' style='margin-bottom:6px'><input id='in_wg_conf' type='file' accept='.conf,text/plain' onchange='wgImportPicker(event)' style='display:none'><button onclick=\"in_wg_conf.click()\" id='b_wg_import'>Import .conf</button><span class='help' id='h_wg_import' style='margin-left:4px'>?</span></div>"
